      ...
      <header className="bg-gradient-to-br from-slate-900 to-blue-900 text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-blue-600 text-white px-8 py-4 rounded-lg font-bold hover:bg-blue-500 transition shadow-lg flex items-center justify-center gap-2" href="https://github.com/amx711/Accessibility-Widget/">
